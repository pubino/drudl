...
## Section Menu
  ...
  * [Prospective Students](/undergraduate/prospective-students)
  * [Guides](/undergraduate/guide) __ Submenu
    * [Academic Guide](/undergraduate/guide)
    * [Senior Thesis Guide](/undergraduate/guides/senior-thesis)
  * [Courses](/undergraduate/courses)
  * [OQDS Minor](/undergraduate/oqds)
  * [Awards](/undergraduate/awards)
  * [Summer Travel Fund](/undergraduate/summer-travel)
  * [Career Development](/undergraduate/career-development)
  * [The Eric F.S. Pai '83 Fund](/undergraduate/eric-fs-pai-83-fund)
...
### Department Chair
  ...
  * [Professor Mete Soner](/people/mete-soner)
...
#### Undergraduate Program Administrator
  ...
  * [Caitlin Daley](/people/caitlin-daley) 
...
M-R| Prof. William Massey  
S-Z| Prof. Ioannis Akrotirianakis  
  
**Class of 2028** (advisers are paired with every fourth student):

Student| Adviser  
---|---  
 | Prof. Rene Carmoa  
 | Prof. Matias Cattaneo  
 | Prof. Ronnie Sircar  
 | Prof. Ludovic Tangpi  
  
All ORFE department offices are located in Sherrerd Hall.
...
In addition to meeting the Engineering School requirements, students will complete courses in the following four groups:

  * Department’s core requirements (4 courses) – These form the intellectual foundation of our field, and cover statistics, probability, stochastic processes, and optimization. _Note:_ Students should complete the core requirements before pursuing independent research, whether that be junior independent work (ORF 375; 376), senior independent project (ORF 497), or the senior thesis (ORF 498; 499).  For ORF 375/376, there may be certain exceptions to this guideline.
  * Departmental electives (10 or 11 courses depending on senior independent research choice).  These are additional courses that either extend and broaden the core, or expose the student to a significant problem area or application closely related to the core program.



### Independent Research

  * Senior Thesis - ORF 498 and ORF 499.  This is a full-year effort that involves a major application of the techniques in the program applied to a topic that a student chooses in consultation with a faculty advisor. Students interested in a full-year senior thesis must be willing to spend the appropriate time during both the fall and the spring semesters.  Students will enroll in ORF 498 in the fall semester, and ORF 499 in the spring, each at one credit.  
OR
  * Senior Independent Project - ORF 497 (spring semester only) - A short progress report is expected in December, (Dean’s Date) to ensure that students have chosen a suitable topic and are paired with their adviser.  The final outcome will be a report due at the end of the spring semester.  The report will fully describe the research project and its results. Typically projects will take approximately 30 to 50 pages. Students who take the independent project will need to take an additional 400-level ORFE departmental elective.
...
The University requires that 36 courses be taken to graduate.  The School of Engineering requires math achievement through Math (MAT 103, 104, 201 and 202, or equivalent), Computer Science proficiency (COS 126), Chemistry (CHM 201 or 207) and Physics (PHY 103, 104).  Ten courses are required to meet the engineering school requirement of 36 courses (more if the student places out of any of the SEAS requirements).  Students are free to select these courses from any department, and are expected to design an academic program with the assigned adviser that produces a balanced education.  No course may count under more than one heading, under any circumstances.

Each student selects and schedules courses in consultation with the assigned academic adviser and the Director of Undergraduate Studies. While generally no exceptions in the core courses are allowed, students may design specialized programs through their choice of departmental electives.  Specialized programs must be approved by the Director of Undergraduate Studies, and students should write to [[email protected]](/cdn-cgi/l/email-protection#ea85988c8f8e9f99aa9a988384898f9e8584c48f8e9fd5999f88808f899ed7b99a8f89838b8683908f8ecfd8daa5b8acafcfd8daba98858d988b87cfd8daba98859a85998b86cc8b879ad188858e93d7ae8f8b98cfd8daae83988f899e8598cfd8da858ccfd8dabf848e8f988d988b8e9f8b9e8fcfd8dab99e9f8e838f99c6) to initiate this conversation.

### Graduate Courses

Graduate courses may be taken for the purpose of scholarly enrichment, and ORF graduate courses will fulfill departmental elective requirements, but the grades will not be included in departmental GPA calculations.  To enroll, students should initiate the request through the University's online form, which will be routed to the course instructor, the ORFE DUS, and lastly, to the residential dean.  **Important:** in order for the ORFE DUS to approve the request, students must first obtain email approval from their academic adviser.  The DUS will then sign the online form upon receipt of that message.  The department offering the graduate course will issue a special permission to enroll.   

### ABET Accredited Engineering Degrees

The Department of Operations Research and Financial Engineering does not offer ABET-accredited engineering degrees.  This has never been a problem for ORFE majors in their pursuit of post-graduate opportunities, and our B.S.E. degrees are fully accredited under Princeton University’s overall accreditation. If, however, it is important that you major in an ABET-accredited program of study (e.g. for eligibility for an outside scholarship), please take this into account when choosing your major.  Further information on which Princeton programs of study are ABET-accredited, please consult [the Undergraduate Announcement](https://ua.princeton.edu/).
...
Students selecting Junior Independent Work need to prepare a proposal including the following:
  ...
  1. Title
  2. 100 word abstract/literature. Abstract will describe the problem, why it is important, why you want to study it, and what you hope to have accomplished by the end of the semester.
  3. "Syllabus" containing weekly readings and work plan, including what you will focus on and what you plan to accomplish in each week of the semester.
  ...
  5. A faculty member who has agreed to supervise your project.  Students are welcome to work with non-ORFE Princeton faculty.
  6. Obtain the Director of Undergraduate Studies’ signature, approving your proposal. 



**The proposal and signed Junior Independent Study Form must be sent to the Undergraduate Administrator ([[email protected]](/cdn-cgi/l/email-protection#bcd3cedad9c9dbfcccced5d2dfd9c8d3d292d9d8c9)) **_**prior**_**to the first day of classes.**  The requirements for satisfactory completion of the study (such as reports, examinations, etc.) are set by the faculty adviser, not the Department, and the student should have a clear understanding about them when the work is begun.  When conducting junior independent work, students should not enroll in more than five courses (including ORF 375/376).  

### Senior Independent Work

#### Senior Thesis (ORF 498 and ORF 499)

The Thesis begins in the spring semester of the junior year, with a selection process to ensure that students are well matched with an adviser.
...
Four reports are required throughout the year, leading up to the final thesis report, which is due in April.  The first report is due in September, the second in October, the third in December, and the fourth in February. The research results will be presented to faculty and fellow students at the end of the spring term. For more information, refer to [the senior thesis guide](/documents/senior-thesis-guide).
...
### Typical Course Schedule
 ...
 _Parentheses signify alternate schedule. Note that if junior independent work is pursued, students should aim to complete all core courses prior to independent research.  _

FIRST YEARFall| Spring  
---|---  
  
  1. CHM 201/207-General Chemistry
  2. MAT 104 Calculus
  3. PHY 103 General Physics
  4. Writing Requirements
  5.  

| 

  1. COS 126 Gen. Comp. Sci.
  2. MAT 201 Multivariance Calc
  3. PHY 104 General Physics 2
  4. (ORF 245 Fund. of Statistics)
  5.  
...
---|---  
  ...
  1. ORF 245 Fund. of Statistics
  2. MAT 202 Linear Algebra Appl.
  3. Departmental Elective
  4. (ORF 309 Probability/Stat Systems)
  5. (ECO 310 Microecon Theory)

| 

  1. ORF 307 Optimization
  2. ECO 310 Microecon Theory
  3. (ORF 309 Probability/Stat Systems)
  4. (ORF 335 Intro Fin. Mathematics)
  5.  
...
---|---  
  ...
  1. ORF 309 Probability/Stat Systems
...
| 
  ...
  1. ORF 335 Intro Fin. Mathematics
  2. Departmental Electives
  3. Departmental Electives
...
The following certificate or minor programs complement well with ORFE and are thus popular with students:
  ...
  * Minor in Optimization and Quantitative Decision Science (housed in ORFE, directed by Professor Ahmadi)
...
#### Boris Hanin, Associate Professor 
...
After graduating from the ORFE department in 2015, Chris went on to receive a PhD in Operations Research from MIT. He spent the next five years working as a quantitative researcher for a high frequency trading firm. The combination of theoretical mathematical tools and practical technical skills that he learned as an ORFE undergrad were invaluable in preparing him to succeed in graduate school and in his career. The breadth and rigor of the curriculum provide students with a fantastic base of knowledge that they can apply to many important problems across a wide range of industries.

Recently, he quit his job in finance and is currently spending the spring 2025 semester as a visiting lecturer back at Princeton in the ORFE department. He is thrilled to have the opportunity to return and to pass on his knowledge and perspective to the next generation of ORFE students.

#### Michelle Scharfstein '15

Michelle Scharfstein '15 graduated from ORFE and started her career at a data analytics consulting company, Applied Predictive Technologies (APT), which has since been acquired into Mastercard's Data & Services business. At APT, Michelle ran statistical analysis and developed models to help Fortune 500 clients make better business decisions. After two years in consulting, Michelle pivoted to software engineering and joined Google where she started on one of Google's Ads products before shifting her focus to algorithmic music recommendations on YouTube and YouTube Music. In this role, Michelle develops, experiments with, and launches features that improve both the quality of music content and the way the content is surfaced for billions of YouTube users. Between the two teams at Google, Michelle also participated in a 6 month "COVID Swat Team" for the NY governor's office through a Google.org fellowship. The skills Michelle cultivated during her time in ORFE, including statistical modeling, programmatic simulation, and general analytical thinking, have helped her succeed in each of her roles since graduation.
...
**Mudd Library Thesis Archive:** [Thesis Central :: Browsing Operations Research and Financial Engineering, 2000-2025 by Issue Date](https://theses-dissertations.princeton.edu/handle/88435/dsp011r66j119j)

  * The Cost of Catastrophe: Climate Change Adaptation and Disaster Risk Financing in Developing Countries
  * Trading Options with Uncertainty Risk Around Earnings Announcements
  * Forecasting Real Estate Backlog: A Regime-Switching Approach
  * Integration of the Regime-Switching Framework for Portfolio Construction with Commodity Futures
  * Employees V. Robots: An Analysis on Automation, Jobs, and Industry Efficiency
  * Attribute Prediction and Garment Similarity Evaluation from Fashion Images
  * Data Analysis for Stock Price Prediction
  * Using the Markov-Switching Autoregressive Model to Classify Semiconductor Regimes and Identify Inflection Points
  * Patents, Citations, and Market Value
  * Dynamic Price Relationships Among EV Battery Metals: A Cointegration and VECM Approach with Trading Strategy Applications
  * Investor Risk-Aversion Levels Over Specific CAT Bond Pricing Determinants
  * A Sensitivity Analysis of Goal-Oriented Dynamic Asset Allocation Strategies
  * Quantifying NFL Head Coach Value: A Look at In-Game Decisions
  * Indicators of Market Performance in the Semiconductor Industry Through the Use of Network Analysis and Portfolio Optimization
  * A Decision-Focused Approach to Optimizing Hospital Patient Flow
  * The Evolution of Algorithmic Trading and Its Impact on Market Quality Following News Announcements
  * Comparing Apples and Oranges: Information Sharing in Supply Chains for Fresh Fruits
  * Inclusive Intelligence: Advancing Fairness in Large Language Models through Fine-Tuning and Hyperparameter Optimization
  * Forecasting Demand for General Aviation Aircraft in the United States
  * Cointegration Analysis of Liquidity Dynamics: Optimizing Trading Efficiency in the Foreign Exchange Market
  * Market Graphs and Portfolio Optimization: A Maximum Clique Analysis
  * Machine Learning for NBA Betting: An Analysis and Exploitation
  * Introducing Granularity to Private Equity Performance Replication
  * Sentimental Signals: An Exploration of Large Language Model Enhanced Bond Trading Strategies
  * A Quantitative Analysis of Optimal NBA Expansion and Relocation Strategy
  * Empirically Bridging Approaches to Latent Class Regression Problems
  * Stayin' Alive, Stayin' Alive: An Optimization Analysis on Reducing Hospital Readmissions for Heart Failure
  * Decoding the Draft: Enhancing NBA Prospect Predictions with Quantified Scouting
  * Optimal Prepositioning of Hurricane Emergency Relief in the Caribbean: A Demand Approach
  * Beyond the Candlesticks: An Integrated Approach to Intraday US Equity Markets Regime Classification and Price Forecasting
  * Exploring the Financial Potential of Fuel Hedging on Optimal Flight Networks
  * Kidney Capitalism: Modeling a Free Market for Kidneys
  * Predicting S&P 500 Changes: An Analysis of Reddit’s Influence and Market Cap Fluctuations
  * Scaling Up Renewables in Texas: A Binary Linear Programming Approach to Cost Effect Integration Under Hourly Supply Demand Constraints
  * A Counterfactual Approach to Modeling Consumer Outcomes With and Without Payment for Order Flow
  * Data-Driven Adjustable Robust Optimization: Decision Making Under Uncertainty
  * Predicting Steam Community Market Prices Using Linear and Non-Linear Models
  * ESMerp: Evolutionary Scale Modeling for Epitopic Residue Prediction in Class-Imbalanced Settings
  * Hedging Rho Exposure in Primary Option Position with Interest-Rate Options
  * Basic Sanitation Regionalization in São Paulo, Brazil: An Operations Research Approach
  * Revolutionizing Medical Imaging Diagnostics: Unveiling the Potential of CNNs, ViTs, and CapsNets in Brain MRI Analysis
  * Optimizing Asset Allocation Between Equity Factors Based On Investor Sentiment Indicators
  * Capitol Gains: Investigating Insider Trading in the United States House of Representatives Using Time Series Analysis
  * Graphon Games for Optimal Investment in a Competitive Market
  * Conversations in Crisis: A Network Analysis Approach to Emotion Exchange on Twitter
  * Implementing and Optimizing Battery Energy Storage Systems in California’s Utility-Scale Solar Plants
  * Sparking Interest: Investigating Drivers of Public Interest Through an Analysis of Google Trends for Extreme Weather Events
  * Predictive Modeling for Food Accessibility: Machine Learning Insights into Food Deserts and Swamps
  * Elucidating a Variational Autoencoder's Encoding of Value-at-Risk
  * Building an Optimal Team: A Comparative Analysis of Cricket Roster Construction Using Advanced versus Traditional Metrics
  * The Predictive Power of Advanced NFL Analytics: Using Machine Learning Strategies and Advanced Analytics to Beat the Books
  * Using Machine Learning to Predict NBA Outcomes and Applying Portfolio Theory and the Kelly Criterion to Optimize Betting Profitability
  * Stabilizing California’s Power Grid: A Two-Pronged Approach
  * Exploring the Impact of Earnings Surprises on Options Bid-Ask Spread in the Energy Sector: Analysis of The US Energy Sector
  * Modeling Intergenerational Economic Mobility Dynamics Via Calibrating Markov Models
  * Weather or Not: Decoding the Effect of Hurricane Forecasts on Crack Spread Dynamics
  * Deep Q-Learning and Parallelized Multi-Algorithimic Hyperparameter Optimization for Video Games: An Application to Haxball
  * Envisioning Automated Glaucoma Screening: Domain Generalization for Deep Learning-Based Glaucoma Classification
  * A Data-driven Inspection of the Silicon Price Market
  * Rethinking the Hype of Transformer Models: Examples from Electric Load Forecasting
  * From Black Box to Glass Box: The Impact of Data Complexity on Machine Learning Explainability
  * A Multi-Objective Optimization Approach to Equitable Urban Cycling Network Growth
  * Proximal Policy Optimization for Optimal Trade Execution with Price Impact
  * Machine Learning Models for Revenue Prediction in the Film Industry: A Comparative Study
  * Dynamic Asset Allocation Under Reservoir-Driven Multivariate Regime Switching
  * Monte Carlo in Asset Management: Diversification Insights from Princeton’s Endowment Strategy
  * Conversations in Crisis: A Network Analysis Approach to Emotion Exchange on Twitter
  * Trading Options with Uncertainty Risk around Earnings Announcements
  * Optimizing Asset Allocation Between Equity Factors Based On Investor Sentiment Indicators
  * Optimal Prepositioning of Hurricane Emergency Relief in the Caribbean: A Demand Approach
 ...
 **Company or Institution**| **Position / Type of Work**  
---|---  
Microsoft| Technical Program Manager  
Princeton University Investment Company (PRINCO)| Unknown  
BlackRock| Portfolio Analytics Group Analyst  
Boston Consulting Group (BCG)| Software Engineer  
Blackstone| Real Estate Acquisitions  
Bridgewater Associates| Engineer  
Bain & Company| Associate Consultant  
Meta| Software Engineer  
JPMorgan Chase & Co.| Software Engineer  
Planet Network Inc| Corporate Strategy Analyst  
Barclays| Investment Banking Analyst  
Syndax Pharmaceuticals| Statistical Programmer  
Blackstone| Analyst  
Planet Network Inc| Unknown  
McKinsey & Company| Business Analyst  
Similarweb| Data Scientist  
Goldman Sachs| Quantitative Analyst (Finance)  
Global Atlantic Financial Group| Investment Analyst  
Lord, Abbett & Co. LLC| Investment Associate  
Howard Hughes Medical Institute| Computational Analyst - Biological Image Processing  
Celonis| Associate Value Engineer  
Araushotels, Inc.| Real Estate Analyst  
Barclays| Investment Banking Analyst  
Barclays| Investment Banking Analyst  
JPMorgan Chase & Co.| Investment Banking Analyst  
McKinsey & Company| Business Analyst  
PwC - Strategy&| Analyst  
Strategic Research Insights, Inc.| Associate Manager Analytics  
Blackstone| Data Science Analyst  
Confident-AI| Co-founder  
Franklin Templeton Investments| Associate Data Scientist  
OC&C Strategy Consultants USA Inc.| Associate Consultant  
Baird| Analyst  
Barclays| Investment Banking Analyst  
LGT Capital Partners| Venture Capital Analyst  
Morgan Stanley| Trading Analyst Intern (Securities, Commodities, and Financial Services)  
Agility Outsourced CIO| Analyst  
Health Net, Inc.| Analyst  
Cubist Systematic Strategies| Quant Research  
Goldman Sachs| Asset & Wealth Management, Private Equity, Strategic Capital Analyst  
LinkIt!| Technical Account Manager  
Citi| Investment Banking First Year Analyst  
...
Blackstone| Data Science Analyst  
FileTier| Web Designer  
Ellington Management Group, LLC| Portfolio Management Analyst  
Blackstone| Investment Analyst  
Group One Trading LP| Trading Analyst  
Sentient Foundation| Chief of Staff  
BlackRock| Systematic Investments  
Brown Advisory| Portfolio Analyst  
BlackRock| Analyst  
